...
st.title("🤖건설 기계 오일 상태 진단")
st.divider()
# 사용자 선택 옵션 설정
option = st.selectbox('⭐원하는 모델을 선택하세요.', 
                      ('COMPONENT1', 'COMPONENT2', 'COMPONENT3A', 'COMPONENT3B', 'COMPONENT3C', 'COMPONENT_ALL & COMPONENT4'))

if option == 'COMPONENT1':
    st.title("COMPONENT1 모델링 결과")
    ...
    # Streamlit 대시보드
    # st.title("Fault Prediction Dashboard")
    ...
    st.title("전체 모델링 결과 / Component 4 결과")
    df = pd.read_csv("./data/casting.csv")
